...
class HolidayExemptions
{
    ...
    public $holiday_exemption_holiday_id;
    ...
    public function create()
    {
        try {
            ...
            $sql .= "holiday_exemption_holiday_id, ";
            ...
            $query->execute([
                ...
                "holiday_exemption_holiday_id" => $this->holiday_exemption_holiday_id,
    ...
    public function update()
    {
        try {
            ...
            $sql .= "holiday_exemption_holiday_id = :holiday_exemption_holiday_id, ";
