...
class Payroll
{
    ...
    public $payroll_list_job_early_13th_month;
    ...
    public function createPayrollList()
    {
        try {
            ...
            $sql .= "payroll_list_job_early_13th_month, ";
            ...
            $query->execute([
                ...
                "payroll_list_job_early_13th_month" => $this->payroll_list_job_early_13th_month,
    ...
    public function readFilterType()
    {
        try {
            $sql = "select *, ";
            $sql .= "COUNT(prlist.payroll_list_employee_id) as count, ";
            ...
            $sql .= "{$this->tblPayrollType} as prtype ";
            $sql .= "where ";
            $sql .= "pr.payroll_category_type = :type ";
            $sql .= "and pr.payroll_category_type = prtype.payroll_type_aid ";
            $sql .= "and pr.payroll_id = prlist.payroll_list_payroll_id ";
            $sql .= "GROUP BY prlist.payroll_list_payroll_id ";
            $sql .= "order by pr.payroll_is_paid asc, ";
            $sql .= "pr.payroll_pay_date desc, ";
    ...
    public function readFilterMonthAndType()
    {
        try {
            $sql = "select *, ";
            $sql .= "COUNT(prlist.payroll_list_employee_id) as count, ";
