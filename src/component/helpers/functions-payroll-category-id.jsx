...
// local dev
// export const payrollCategorySalaryId = 1; // salary category id
// export const payrollCategory13thMonthId = 2; // 13th month category id
// export const payrollCategoryBonusId = 3; // bonus category id
