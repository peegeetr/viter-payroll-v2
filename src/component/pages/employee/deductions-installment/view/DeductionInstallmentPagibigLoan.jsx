...
import ModalAddPagibigLoan from "../optional-deduction/ModalAddPagibigLoan";

const DeductionInstallmentPagibigLoan = () => {
  ...
  const { data: payItem } = useQueryData(
    `${devApiUrl}/v1/payitem/${PagibigLoanId}`, // endpoint
    "get", // method
    `payItem${PagibigLoanId}` // key
  );
  // use if not loadmore button undertime
  ...
  return (
    <>
      ...
      {store.isAdd && <ModalAddPagibigLoan item={itemEdit} />}
...
export default DeductionInstallmentPagibigLoan;
