...
import ModalPayrollType from "./ModalPayrollType.jsx";
import PayrollTypeList from "./PayrollTypeList.jsx";
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen pt-20 ml-0 px-5 md:ml-20 lg:ml-40 lg:px-10">
        ...
        <PayrollTypeList setItemEdit={setItemEdit} />

        <hr />
        <div className="w-full pt-5 pb-20"></div>
        <Footer />
      </div>
      {store.isAdd && <ModalPayrollType itemEdit={itemEdit} />}
